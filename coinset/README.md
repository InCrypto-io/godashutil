...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/btcsuite/godashutil/coinset)
...
```bash
$ go get -u github.com/incrypto-io/godashutil/coinset
```
